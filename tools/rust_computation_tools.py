...
class RustDataProcessorTool(BaseTool):
    ...
    async def execute(self, operation: str, data: list[dict[str, Any]], options: dict[str, Any] | None = None) -> ToolResult:
        try:
    ...
    def _process_data(self, operation: str, data: list[dict[str, Any]], options: dict[str, Any]) -> dict[str, Any]:
        ...
        if operation == "sort":
            ...
            if key:
                ...
                # Dicts aren't comparable in Python 3, return as-is
                result = data[:]
