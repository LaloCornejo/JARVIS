...
class ModelSelection:
    backend: Literal["ollama", "copilot", "gemini", "omniroute"]
    model: str
...
class ModelRouter:
    def __init__(
        ...
        omniroute_client: OpenAICompatClient | None = None,
        ollama_model: str | None = None,
        copilot_model: str | None = None,
        gemini_model: str | None = None,
        omniroute_model: str | None = None,
        primary_backend: Literal["ollama", "omniroute"] = "ollama",
        use_copilot_for_complex: bool = False,
    ):
        ...
        self.omniroute_model = omniroute_model or "auto"
    ...
    def select_model(
        ...
        if self.omniroute_client and self.primary_backend == "omniroute":
            return ModelSelection(backend="omniroute", model=self.omniroute_model)
