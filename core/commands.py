...
class CommandHandler:
    ...
    async def _handle_forget(self, match: re.Match) -> CommandResult:
        ...
        try:
            semantic = await get_enhanced_memory()
            await semantic.clear_all()  # type: ignore[reportAttributeAccessIssue]
        ...
        try:
            ...
            await episodic.clear_all()  # type: ignore[reportAttributeAccessIssue]
...
Just type what you need and I'll help."""
    ...
    async def _handle_recall(self, match: re.Match) -> CommandResult:
        ...
        try:
            ...
            results = vector.search(topic, limit=5)
